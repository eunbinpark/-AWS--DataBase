...
INSERT INTO `order` VALUES (1,1,'aaa',1000,'박은빈','부산시 남구 대연동'),(2,1,'bbb',2000,'박은빈','부산시 남구 대연동'),(3,2,'aaa',1000,'고병수','부산시 부산진구 사야동'),(4,3,'aaa',1000,'손민재','부산 남구 대연동');
...
-- Dump completed on 2023-01-19 17:43:01

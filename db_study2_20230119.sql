CREATE DATABASE  IF NOT EXISTS `db_study2` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_study2`;
...
CREATE TABLE `course_mst` (
  ...
  `lecture_price` int DEFAULT NULL,
...
INSERT INTO `course_mst` VALUES (1,'김동민','java',100000,'김준일','서울대'),(2,'김두영','java',100000,'김준일','서울대'),(3,'장진원','python',80000,'김준이','부산대'),(4,'김두영','c',90000,'김준삼','경상대');
...
INSERT INTO `instructor_mst` VALUES (1,'김준일'),(2,'김준이'),(3,'김준삼');
...
-- Dump completed on 2023-01-19 17:43:31
